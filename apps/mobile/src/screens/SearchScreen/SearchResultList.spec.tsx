...
import * as Hook from '../../../../../libs/movie-api/src/hooks/useSearchMovie';
...
describe('SearchResultList', () => {
	...
	it('renders correct contents', () => {
		jest.spyOn(Hook, 'useSearchMovie').mockReturnValue({ ...mockReturnValue, data: [] } as any);

		const view = render(<SearchResultList {...props} />, { wrapper });
	...
	it('renders list items', () => {
		jest.spyOn(Hook, 'useSearchMovie').mockReturnValue(mockReturnValue as any);
